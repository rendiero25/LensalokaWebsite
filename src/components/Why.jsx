                ...
                <div className='flex justify-center items-center'>
                    <div className="container w-full mx-auto px-6 sm:px-12 ">
                        <div className="flex flex-col md:flex-row justify-between md:items-end md:gap-8 mb-5 xl:mb-10">
                            <h2 className="font-primary leading-tight text-3xl w-full md:text-5xl text-center font-normal text-[#273F3A] mb-4 md:mb-0 md:mr-6 whitespace-pre-line">
                                Lebih dari Sekadar Photobooth
                            </h2>
                            {/* <p className="font-secondary text-md font-normal md:text-2xl text-center md:text-left text-[#273F3A] max-w-2xl">
                                Kami membantu Anda menciptakan pengalaman berharga
                                yang tak terlupakan dengan sentuhan elegan dan kualitas premium.
                            </p> */}
                        </div>

                        <div className="xl:mt-10 flex flex-col md:flex-row gap-5 md:gap-6 lg:gap-12 justify-center items-stretch">
                            {/* Icon 1 */}
                            <div className="flex flex-col items-center text-center rounded-xl p-6 flex-1 bg-primary">
                                <img src={Icon1} alt="Seamless Experience" className="h-16 w-16 mb-4" />
                                <h3 className="font-primary text-lg md:text-2xl xl:text-3xl font-normal text-white mb-4">Seamless Experience</h3>
                            ...
                            <div className="flex flex-col items-center text-center rounded-xl p-6 flex-1 bg-primary">
                                ...
                                <h3 className="font-primary text-lg md:text-2xl xl:text-3xl font-normal text-white mb-4">High-Quality Prints & Setup</h3>
                            ...
                            <div className="flex flex-col items-center text-center rounded-xl p-6 flex-1 bg-primary">
                                ...
                                <h3 className="font-primary text-lg md:text-2xl xl:text-3xl font-normal text-white mb-4">Memorable Engagement</h3>
