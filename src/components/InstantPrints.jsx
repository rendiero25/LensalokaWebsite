    ...
    return (
        ...
        >
            ...
            <div className="w-full px-6 sm:px-12 mb-10 text-center flex flex-col justify-between items-center">
                ...
                <p className="font-secondary font-normal text-base md:text-2xl text-[#273F3A] max-w-4xl mb-8">
            ...
            <div className="flex flex-col md:flex-row w-full">
                {/* Portrait */}
                <div
                    className="z-10 flex-1 flex flex-col justify-end items-start min-h-[260px] md:min-h-[800px] bg-cover bg-center text-white"
