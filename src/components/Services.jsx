...
const Services = () => {
    return (
        <section 
            ...
            style={{
                backgroundImage: 'linear-gradient(to bottom, #F5B52F 0%, #fff 100%)',
                ...
                <div className='flex justify-center items-center'>
                    <div className="container mx-auto px-6 sm:px-12 py-10 xl:py-10">
                        ...
                        <div className="flex flex-col md:flex-row gap-10">
                            ...
                            <div className="relative flex-1 overflow-hidden shadow-2xl h-[500px] flex flex-col justify-end">
                                <video
                                    ...
                                    playsInline
                                />
                                <div className="absolute top-0 left-0 w-full h-full bg-[#273F3A]/70 z-10" />
                                ...
                                <div className="relative z-20 p-10 xl:p-20 flex flex-col items-center h-full justify-between">
                                    ...
                                    <div className='flex flex-col justify-between items-center gap-4'>
                                        ...
                                        <a
                                            ...
                                            className="bg-secondary text-[#273F3A] font-bold px-8 text-center py-3 rounded-full shadow hover:bg-[#ffd966] transition font-secondary"
                                        >
                                        Pesan Sekarang
                                    </a>
                                    </div>
                                ...
                                <div className="relative z-20 p-10 xl:p-20 flex flex-col items-center h-full justify-between">
                                    ...
                                    <div className='flex flex-col justify-between items-center gap-4'>
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="bg-secondary text-[#273F3A] text-center font-bold px-8 py-3 rounded-full shadow hover:bg-[#ffd966] transition font-secondary"
                                        >
                                        Pesan Sekarang
                                    </a>
                                    </div>
